document.addEventListener("DOMContentLoaded", function ()
{
	...
	let noteColor = localStorage.getItems("noteColor") || "ffff88" // Stores the selected note color from the form.
...
const savedNotes = JSON.parse(localStorage.getItem("notes")) || []; // Array to hold the saved notes.

	// Recreate saved notes from local storage.
	function addNewNote ()
	{
